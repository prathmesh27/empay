	...
	<header>
		...
		<div class="header-sec container">
			<div class="logo-sec">
				...
				<img src="images/humberger.svg" class="menu">
	            <div class="Sidenavbar">
	                <ul>
	                    <li><a href="index.php" class="no-bold">Home page</a></li>
	                    <li><a href="aboutus.php" class="no-bold">about us</a></li>
	                    <li><a href="faq.php" class="no-bold">faq</a></li>
	                    <li><a href="services.php" class="no-bold">media</a></li>
	                    <li><a href="patner.php" class="no-bold">patners</a></li>
	                </ul>
	            </div>
			</div>
